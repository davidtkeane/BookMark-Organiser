...
### Changed
- **Total Action Button Unification**: Extended the professional white-and-slate styling to the sidebar's "Magic Sync" and "Import HTML File" buttons. All primary ingest and maintenance actions across the application now share a perfectly consistent visual identity.
...
### Fixed
- **Brave Logo Fix**: Corrected the URL for the Brave browser icon to ensure it displays properly in the sidebar.
...
### Changed
- **UI Consistency**: Renamed the primary "Run System Checks" button to **"Scan Now"** to align with the new granular scanning actions on the dashboard.
